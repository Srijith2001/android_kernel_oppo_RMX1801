...
#Guoqiang.Jiang@PSW.MM.Display.LCD.Stability, 2018/08/30, Add for 18321 ffl fuction
ifeq ($(OPPO_TARGET_DEVICE),MSM_18321)
  KBUILD_CFLAGS +=   -DIS_PROJECT_18321
  KBUILD_CPPFLAGS += -DIS_PROJECT_18321
  CFLAGS_KERNEL +=   -DIS_PROJECT_18321
  CFLAGS_MODULE +=   -DIS_PROJECT_18321
endif
